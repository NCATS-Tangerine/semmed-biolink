...
UMLS_YEAR = os.getenv("UMLS_YEAR")
UMLS_TAG = os.getenv("UMLS_TAG")
...
METAMAP_YEAR = os.getenv("METAMAP_YEAR")
METAMAP_TAG = os.getenv("METAMAP_TAG")

SEMGROUPS = "https://metamap.nlm.nih.gov/Docs/SemGroups_"+METAMAP_YEAR+".txt"
SEMTYPES = "https://metamap.nlm.nih.gov/Docs/SemanticTypes_"+METAMAP_YEAR+METAMAP_TAG+".txt"
...
SEMMEDDB_VERSION = os.getenv("SEMMEDDB_VERSION")
SEMMEDDB_PUBMED_RELEASE = os.getenv("SEMMEDDB_PUBMED_RELEASE")
...
NODES_KGX_TSV = DATA+"semmeddb_"+SEMMEDDB_VERSION+"_"+SEMMEDDB_PUBMED_RELEASE+"_kgx_nodes.tsv"
EDGES_KGX_TSV = DATA+"semmeddb_"+SEMMEDDB_VERSION+"_"+SEMMEDDB_PUBMED_RELEASE+"_kgx_edges.tsv"
