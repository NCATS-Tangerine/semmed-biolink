...
# Data file targets:
SEMMEDB_FILE_PREFIX=semmedVER${SEMMEDDB_VERSION}
echo "SEMMEDB_FILE_PREFIX: ${SEMMEDB_FILE_PREFIX}"

# SemMedDb 2019 data release file name in original Greg Stupp script
# SEMMEDDB_PREDICATION_FILE=${SEMMEDB_FILE_PREFIX}_R_PREDICATION_${SEMMEDDB_PUBMED_RELEASE}
# Revised file name format in SemMedDb 2020 data release

# Predication Table Data Targets:
: ${SEMMEDDB_PREDICATION_FILE:=${SEMMEDB_FILE_PREFIX}_${SEMMEDDB_PUBMED_RELEASE}_R_PREDICATION}
...
SEMMEDDB_CITATIONS_FILE=${SEMMEDB_FILE_PREFIX}_${SEMMEDDB_PUBMED_RELEASE}_R_CITATIONS
...
SEMMEDDB_PREDICATION_AUX_FILE=${SEMMEDB_FILE_PREFIX}_${SEMMEDDB_PUBMED_RELEASE}_R_PREDICATION_AUX
...
SEMMEDDB_SENTENCE_FILE=${SEMMEDB_FILE_PREFIX}_${SEMMEDDB_PUBMED_RELEASE}_R_SENTENCE
